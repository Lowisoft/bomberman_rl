...
def coin_collector_act(self, game_state) -> str:
    """ Returns the action that would be played by the coin collector agent.
        This is used to break loops of the reinforcement learning agent.
        Taken from coin_collector_agent/callbacks.py
    """
